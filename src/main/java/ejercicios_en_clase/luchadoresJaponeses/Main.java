 ...
 * 
 * Una academia dedicada a las difíciles artes de lucha oriental, está
 * organizando un torneo de luchadores sumo.
 * 
 * A los efectos de conformar la grilla de combates, es necesario armar parejas
 * de luchadores que puedan ofrecer un espectáculo atractivo. Como es sabido que
 * los cultores de esta disciplina son hombres de estructura física imponente,
 ...
 * comparables lo que hace el resultado imprevisible y por lo tanto más
 ...
 * de ellos, y por esta razón se te pide que escribas un programa que efectúe
 * este recuento
 * 
 * Datos de entrada 
 * Se recibe un archivo sumo.in con el siguiente formato: 
 * 	-Una línea que indica la cantidad L (1 ≤ L ≤ 100.000) de luchadores. 
 * 	-L líneas con 2 números P y H (0 ≤ P,H ≤ 1.000.000) que indican el peso y la altura de cada
 * participante, separados por blancos.
 * 
 * Datos de salida
 * Se debe generar un archivo sumo.out conteniendo
 * 	-L líneas con la cantidad de luchadores a quienes domina cada participante, en el mismo
